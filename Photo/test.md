欢迎访问：[作者个人博客-zobolの计算机操作系统学习札记](https://zobolblog.github.io/LearnOperatingSystem/Doc/01Summary/0002TheSecondFunctionConcurrentFunction.html)

* 1.什么是并发功能？并发功能是**必要的**吗？
* 2.并发功能必须要求拥有**多核CPU**吗？
* 3.**多核CPU和单核CPU**对并发功能的实现，有影响吗?
* 4.并发功能的并发性是**绝对的**，还是**相对的**？
* 5.**GPU显卡**的并发性是如何实现的？
...
<p align="center"><img width="600" height="200" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4883de5164f44fc3b6cf7f67b03f40d8~tplv-k3u1fbpfcp-zoom-1.image"></p>
...
<p align="center"><img width="400" height="150" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4199414523cd445b8e3cafcf74b3c3d9~tplv-k3u1fbpfcp-zoom-1.image"></p>
